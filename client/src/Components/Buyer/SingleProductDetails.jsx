  ...
  return (
    <div className={`py-5`}>
          ...
          <div className={`row`}>
            ...
            {reviews?.length > 0 &&
              reviews?.map((review, index) => (
                <div className={`col-12 px-4 py-3 border-bottom`} key={index}>
                  <div className={`row`}>
                      ...
                      <div className={`row`}>
                        ...
                        >
                          <div>
                            ...
                            >
                              {formatDateAndTimeFromString(review?.review_date)}
                            </p>
                          </div>
                        </div>
                        <div
            ...
            <div className={`col-12 px-4 py-3 border-bottom`}>
              ...
              >
                ...
                <div>
                  <span className={`pe-2`}>Rate the product</span>{" "}
                  {randerStars(rating)}
                </div>
      ...
      <ProductBox
        ...
        category={category_ids && category_ids[0]}
      />
    </div>
  );
}
